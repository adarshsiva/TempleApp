...
public class InsertData extends AppCompatActivity {
    ...
    String id,name,poojaTyp,overall,money,paidCheck = getResources().getString(R.string.not_paid);
    Spinner poojaType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.radio_donate:
                        ...
                        flag = 0;
                        Toast.makeText(getBaseContext(), getResources().getString(R.string.selected_donate), Toast.LENGTH_LONG).show();
                        break;
                    case R.id.radio_pooja:
                        totalLayout.setVisibility(View.VISIBLE);
                        moneyDonated.setVisibility(View.GONE);
                        poojaType.setVisibility(View.VISIBLE);
                        id = getResources().getString(R.string.REG);
                        flag = 1;
                        Toast.makeText(getBaseContext(), getResources().getString(R.string.selected_register), Toast.LENGTH_LONG).show();
                        break;
        ...
        paid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((CheckBox) v).isChecked()) {
                    paidCheck = getResources().getString(R.string.PAID);

                } else {
                    paidCheck = getResources().getString(R.string.NOT_PAID);
                }
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (id.length() == 3) {
                    uid1ET.setError(getResources().getString(R.string.valid_ID));
                }
                else {
                    if (flag == 1) {
    ...
    class InsertDataActivity extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog.setMessage(getResources().getString(R.string.insert));
            dialog.show();
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.i(Controller.TAG, getResources().getString(R.string.json_obj));
            ...
            try {
                ...
                Log.i(Controller.TAG, getResources().getString(R.string.exception) + je.getLocalizedMessage());
            }
            return null;
        }
