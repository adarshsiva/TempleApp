...
public class UpdateData extends AppCompatActivity {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.radio_donate:
                        ...
                        flag = 0;
                        Toast.makeText(getBaseContext(), getResources().getString(R.string.UPDATE), Toast.LENGTH_LONG).show();
                        break;
                    case R.id.radio_pooja:
                        ...
                        flag = 1;
                        Toast.makeText(getBaseContext(), getResources().getString(R.string.update_pooja), Toast.LENGTH_LONG).show();
                        break;
    ...
    class UpdateDataActivity extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog.setMessage(getResources().getString(R.string.JSON));
            dialog.show();
