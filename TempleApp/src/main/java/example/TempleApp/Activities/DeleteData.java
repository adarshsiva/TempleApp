...
public class DeleteData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.radio_donate:
                        ...
                        flag = 0;
                        Toast.makeText(getBaseContext(), getResources().getString(R.string.delete_donated), Toast.LENGTH_LONG).show();
                        break;
                    case R.id.radio_pooja:
                        totalLayout.setVisibility(View.VISIBLE);
                        flag = 1;
                        Toast.makeText(getBaseContext(), getResources().getString(R.string.delete_pooja), Toast.LENGTH_LONG).show();
                        break;
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (flag == 1) {
                    id = getResources().getString(R.string.REG) + uid1ET.getText().toString();
                } else {
                    id = getResources().getString(R.string.DON) + uid1ET.getText().toString();
                }
    ...
    class DeleteDataActivity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.i(Controller.TAG, getResources().getString(R.string.json_obj) + jsonObject);
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    result = jsonObject.getString(getResources().getString(R.string.result));
