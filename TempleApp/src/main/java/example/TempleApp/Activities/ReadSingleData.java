...
public class ReadSingleData extends AppCompatActivity {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    ...
                    case R.id.radio_pooja:
                        totalLayout.setVisibility(View.VISIBLE);
                        flag = 1;
                        Toast.makeText(getBaseContext(), getResources().getString(R.string.selected_pooja), Toast.LENGTH_LONG).show();
                        break;
    ...
    class ReadDataActivity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            Log.i(Controller.TAG, getResources().getString(R.string.ID_value) + id);
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    JSONObject user = jsonObject.getJSONObject(getResources().getString(R.string.user));
                    name = user.getString(getResources().getString(R.string.name));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (name != null) {
                id_l.setText(getResources().getString(R.string.ID));
                name_l.setText(getResources().getString(R.string.name_));
                int flag = 0;
                if (id.substring(0, 3).equals(getString(R.string.DON))) {
                    id_v.setText(id.substring(3, id.length()));
                    flag = 1;
                } else if (id.substring(0, 3).equals(getResources().getString(R.string.reg))) {
                    id_v.setText(id.substring(3, id.length()));
                    flag = 0;
                }
                ...
                if (flag == 0) {
                    pooja_v.setText(getResources().getString(R.string.type_of_pooja));
                } else {
                    pooja_v.setText(getResources().getString(R.string.money_donated));
                }
                paid_l.setText(getResources().getString(R.string.paid_status));

            } else
                Toast.makeText(getApplicationContext(), getResources().getString(R.string.id_not_found), Toast.LENGTH_LONG).show();
        }
    }
}